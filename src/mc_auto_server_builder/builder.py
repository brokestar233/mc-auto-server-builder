...
from .server_installers import (
    apply_modern_loader_start_mode,
    parse_start_command_from_run_scripts,
    pick_installed_server_jar,
    recover_start_command_from_existing_server_artifacts,
    set_start_command,
    write_start_script,
)
from .util import (
...
class ServerBuilder:
    ...
    def _pick_installed_server_jar(
        ...
        return pick_installed_server_jar(self, loader=loader, mc_version=mc_version, loader_version=loader_version)

    def _parse_start_command_from_run_scripts(self) -> bool:
        return parse_start_command_from_run_scripts(self)

    def _apply_modern_loader_start_mode(self) -> bool:
        return apply_modern_loader_start_mode(self)
    ...
    def _recover_start_command_from_existing_server_artifacts(
        ...
        return recover_start_command_from_existing_server_artifacts(
            self,
            loader=loader,
            mc_version=mc_version,
            loader_version=loader_version,
